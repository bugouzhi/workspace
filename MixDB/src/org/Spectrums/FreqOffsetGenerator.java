...
public class FreqOffsetGenerator {
	...
	public static void getUnExplainedFreqOffSet(String spectrumFile){
		...
		for(Iterator<Spectrum> it = lib.getAllSpectrums().iterator(); it.hasNext();){
			...
			LinkedPeptide lp = new LinkedPeptide(current.peptide, current.charge, 1, 6);
	...
	public static void main(String[] args){
		...
		getUnExplainedFreqOffSet("..\\mixture_linked\\lib_sumo1_spectra_long_single_peptide_search_with_pyroQ.mgf");
