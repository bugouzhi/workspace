...
public class DatabaseIndexer {
	...
	private double resolution=1.0; //this field should be set only during construction, ohterwise will mess up the key mapping	
	FastaSequence seq;
	...
	public static void testIndexDB(){
		DatabaseIndexer indexer = new DatabaseIndexer("../mixture_linked/database/Human_allproteins.fasta");
	}
