...
public class MixtureSVMClassify {
	private String currentPath="../mixture_linked/MixDBv1.0/";
	...
	private int beginFeatureInd=10;
	private int endFeatureInd=25;
	private int rawScoreInd = 10;
	private double minScore = 50;
	private int totalColumns = 27;
