...
//			}
	...
	private double getPIF(Peptide p, int scanNum){
		...
		if(p!=null){
			...
			pif = this.reader.getPIF(scanMS1, p.getParentmass(), 30, -1*(remain+0.5), (25-remain+0.5), 4, p.getCharge()); //the 0.5 Da on either side of window is for handling overlap btw two consecutive swath window
		}
		return pif;
	}
