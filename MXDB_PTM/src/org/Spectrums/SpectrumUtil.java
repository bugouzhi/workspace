...
public class SpectrumUtil {
	...
	public static void annotateSpectrumLibFromMzXMLs(){
		String spectrumDir = "../mixture_linked/msdata/gringar/swath_development/";
		String annotationFile = "..\\mixture_linked/ACG_swathdevelopment_P94_UPS_Ecoli_MSGFDB_IDs_uniqpeps.txt";
		String outfile = "..\\mixture_linked\\test.mgf";
		...
		try{
			...
			while((line=buff.readLine()) != null){
				...
				if(!file.equals(prevFile)){
					reader = new MZXMLReader(spectrumDir+"/"+file);
					prevFile = file;
				}
